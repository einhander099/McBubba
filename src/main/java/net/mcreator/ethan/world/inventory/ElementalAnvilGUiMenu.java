...
package net.mcreator.ethan.world.inventory;
...
public class ElementalAnvilGUiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ElementalAnvilGUiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(EthanModMenus.ELEMENTAL_ANVIL_G_UI.get(), id);
