...
@Mod("ethan")
public class EthanMod {
	public static final Logger LOGGER = LogManager.getLogger(EthanMod.class);
	public static final String MODID = "ethan";
